class Streamline {
	constructor(sendFiles, port) {
		...
		// this.num_processes = require('os').cpus().length;
		// this.express = require('express'),
		// this.io = require('socket.io');
		// this.sio_redis = require('socket.io-redis');
	...
	connect(func) {
		// const developer = require('../server.js');
	...
	map(socket, data, config) {
		...
		setInterval(() => {
			...
			//console.log('emitConfig', emitConfig)
